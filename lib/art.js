...
const STYLE_PREFIX = `Hand-carved linocut relief print. White carved lines on solid black background. Dense organic hatching and crosshatching with irregular, imperfect hand-carved marks. Thick gouged lines, textural and tactile like a real physical print pulled from a carved block. Simplified powerful forms, not detailed realism. High contrast, stark black and white only. No gray tones, no gradients, no halftones. Museum-quality fine art relief print. The subject should fill the entire composition with no border or margin. Raw, physical, monumental.`;
