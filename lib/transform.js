...
1. "imagePrompt" — A vivid 2-3 sentence scene description for a bold woodcut print. Describe ONE dominant visual subject that symbolizes this moment. Think like a printmaker: bold shapes, dramatic perspective, a single monumental form filling the frame. Do NOT mention art style or technique. Just describe the visual subject.

2. "headline" — A short factual headline, 3-8 words, ALL CAPS. What happened. Think newspaper headline style. Examples: "HORMUZ BLOCKADE — DAY 12", "GAZA CEASEFIRE REJECTED", "FUEL AT RECORD HIGHS FOR 43 DAYS"

3. "truism" — A Jenny Holzer-style truism, 6-15 words, ALL CAPS. What this moment reveals about power, systems, or human nature. Must stand alone as a universal truth, not just a comment on the headline. Declarative. No metaphors. No poetry. No hedging. Examples: "THE PRICE OF FUEL IS THE PRICE OF OBEDIENCE", "EVERY EMPIRE CALLS ITS WARS NECESSARY", "PEACE IS ONLY OFFERED WHEN WAR BECOMES EXPENSIVE"

4. "source" — The news source abbreviation (AP, NPR, BBC) of the primary headline that inspired this.

Rules:
- The truism must feel true beyond today's news — like something carved into a building
- The headline must be factual and clear — a viewer should understand what's happening
- The imagePrompt should describe a SINGLE bold subject, not a complex scene
