...
Good examples:
- "Wrap heavy iron chains around the owl's body, coiling between its feathers and pressing tight against its chest. Some links pass behind the owl, some in front. Black and white woodcut with dimensional depth."
- "A crown of barbed wire encircles the owl's head, thorns catching in its ear tufts. The wire wraps around and behind the head, creating depth. Black and white woodcut style."
- "The owl grips a cracked human skull in its talons, claws digging deep into bone. Black and white woodcut, no color."
