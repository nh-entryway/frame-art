...
2. "imagePrompt" — A vivid 2-3 sentence description of ONE subject rendered as a PORTRAIT that ILLUSTRATES THE TRUISM (not the headline). Think like a linocut printmaker: the subject faces the viewer, fills the entire block, and is defined by bold silhouette and carved form. A massive anchor seen head-on. A human hand gripping iron bars. A wolf's face staring straight out. The subject must be immediately nameable from across a room. No background, no environment, no secondary elements. Do NOT mention art style or technique.
...
Rules:
- Write the truism FIRST, then create an image that embodies it
- The truism must feel true beyond today's news — carved into a building
- The headline must be factual and clear
- The imagePrompt should describe a SINGLE bold subject that visualizes the truism
