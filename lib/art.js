...
/**
 * Generate art using OpenAI DALL-E via AI Gateway
 */
export async function generateArt(sceneDescription) {
  ...
  // Try OpenAI through the AI Gateway
  const res = await fetch('https://ai-gateway.vercel.sh/openai/v1/images/generations', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
