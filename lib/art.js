...
Write ONE short editing prompt (1-2 sentences, under 50 words). Describe how the prop physically interacts with the owl's body — wrapping around it, pressing into feathers, gripped in talons, draped over shoulders. The prop must feel CARVED INTO the same woodcut block, not pasted on top.

Good examples:
- "Wrap heavy iron chains around the owl's body, coiling between its feathers and pressing tight against its chest. Carved black and white woodcut style."
- "A crown of barbed wire encircles the owl's head, thorns catching in its ear tufts. Same carved relief print style, pure black and white."
- "The owl grips a cracked human skull in its talons, claws digging into bone. Black and white woodcut, no color."

Rules:
- Keep it SHORT — under 50 words. FLUX.2 works best with concise prompts.
- Describe PHYSICAL CONTACT: wrapping, pressing, gripping, coiling, piercing, draping
- End with: "Carved black and white woodcut style, no color."
