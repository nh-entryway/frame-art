...
CRITICAL: All added elements MUST be rendered in the SAME black and white hand-carved woodcut relief print style as the owl. No color. No photorealism. No gradients. Every added element (chains, helmets, objects) must look like it was carved from the same linoleum block — white carved lines on solid black, with hatching for texture. The entire image must remain a unified black and white print.

Good prompt examples:
- "Add heavy iron chains wrapped around the owl's body and talons, rendered in the same carved black and white woodcut style with visible hatching on each link. Maintain the owl's pose, its direct gaze, and the solid black background. Pure black and white only, no color, no gradients."
- "Place a steel military helmet on the owl's head, carved in the same relief print style with parallel hatching lines for metallic texture. Keep the owl's confrontational expression and the unified black and white woodcut aesthetic throughout."
- "Change the owl's talons to grip a crumbling globe with cracks spreading across continents, all rendered as white carved lines on solid black. Preserve the hand-carved woodcut line work throughout — every element must match the owl's relief print style."

Rules:
- Use direct editing language: "Add...", "Place...", "Change...", "Wrap the owl in..."
- ALWAYS specify: "rendered in the same carved black and white woodcut style" for every added element
- ALWAYS end with: "Pure black and white only, no color, no gradients. Maintain the owl's pose and direct gaze."
